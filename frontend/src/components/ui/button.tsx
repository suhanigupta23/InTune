  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // InTune brand variants
        hero: "bg-button-gradient text-primary-foreground hover-glow hover:scale-105 shadow-button font-semibold",
        warm: "bg-accent-gradient text-accent-foreground hover-lift border border-accent/30",
        minimal: "bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground hover-lift",
      },
      size: {
