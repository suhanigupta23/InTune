    ...
    const fetchChatData = async () => {
      try {
        ...
        if (candRes.ok && meData.vibeText) {
          ...
          // The backend already calculates matches using Python SBERT similarity and sorts them!
          const top4Candidates = candData.slice(0, 4);
              ...
              <>
                ...
                <div className="bg-gradient-to-r from-light-cream to-creamy-beige border-b border-soft-sand py-4 px-6 flex items-center justify-between">
                 ...
                 <div 
                   ...
                   className="flex-1 overflow-y-auto p-6 space-y-4 max-h-[480px]"
                 >
                   {messages.length === 0 ? (
